    ...
    <main>
        <form action="{{ route('login.post') }}" method="POST">
            ...
            <fieldset>
                ...
                @error('pass') <!-- تأكد من تغيير 'pas' إلى 'pass' -->
                <span>{{ $message }}</span>
                @enderror
                ...
                <input type="password" name="pass" placeholder="Enter your password" class="in">

                <div class="sub">
                    <input type="submit" name="submit" value="Log In" class="submit"> <!-- تأكد من أن النص هنا يتناسب مع الحدث -->
                    <h2 class="h2">OR</h2>
                    <a href="/signup" class="a">
                        <div class="adiv">Sign Up</div>
                    </a>
                </div>
            </fieldset>
        </form>
