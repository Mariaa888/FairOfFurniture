...
?>
    ...
    <link rel="stylesheet" href="{{ asset('css/proudct.css')}}" />
</head>
...
<body>
    ...
    <div class="contain">
        <nav>
            ...
            <li onclick="show()"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    c7lass="bi bi-list" viewBox="0 0 16 16">
    ...
    <div class="cartTab">
        ...
        <div class="btn">
            ...
            @else
            <button class="checkOut" onclick="window.location.href='/login'">Check Out</button>
            @endif
        </div>
    </div>
